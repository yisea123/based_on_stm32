...
void AD7175_Reset(void)
{
    ...
    SPI_Write(1, wrBuf, 9);         //发送8个字节0xff以复位AD7175
}
/**************************************************************************//**
...
* @return Returns 0 for success or negative error code.
******************************************************************************/
int32_t AD7175_WriteRegister(st_reg reg)                                //朝AD7175指定的寄存器中写入数据
{
...
float Get_ADC_Reault_ADC_average(uint16_t CH_num,uint16_t setup_cfg)
{
    int32_t a[10]= {0};
    int32_t xx=0,yy;
    int8_t i=0,j=0;
...
//*******From max to min: a[0]=max.....a[9]=min
    ...
    */
	...
	ADC_average = (float)((4.096*ADC_average)/16777216.0-2.048)*2;
    return ADC_average;
}
//============================================================================
//8001      AIN0_AIN1
